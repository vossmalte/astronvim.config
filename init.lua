...
local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      -- leap
      ["s"] = { "<Plug>(leap-forward-to)", desc = "hello leap" },
      ["S"] = { "<Plug>(leap-backward-to)", desc = "hello leap" },
    },
    t = {
  ...
  plugins = {
    ...
    ["null-ls"] = function(config) -- overrides `require("null-ls").setup(config)`
      ...
      config.sources = {
        ...
        null_ls.builtins.formatting.eslint_d.with {
          timeout = 10000,
          extra_args = { "--cache", "--no-eslintrc", "-c", ".eslintrc_relaxed.js" },
        },
    ...
    heirline = function(config)
      ...
      config[2] = {
        ...
        -- if the window is currently active, show filepath and breadcrumbs
        {
